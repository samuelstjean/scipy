...
class TestCDFlib(object):
    ...
    def test_bdtrin(self):
        _assert_inverts(
            ...
            rtol=1e-15, endpt_atol=[None, None, 1e-6])
    ...
    def test_btdtrib(self):
        ...
        _assert_inverts(
            ...
            1, [Arg(0, 1e2, inclusive_a=False), ProbArg(),
             Arg(0, 1, inclusive_a=False, inclusive_b=False)],
            rtol=1e-15, endpt_atol=[None, 1e-18, 1e-15])
    ...
    def test_gdtria(self):
        _assert_inverts(
            ...
            0, [ProbArg(), Arg(0, 1e3, inclusive_a=False),
                Arg(0, 1e4, inclusive_a=False)], rtol=1e-15,
    ...
    def test_gdtrib(self):
        ...
        _assert_inverts(
            ...
            lambda a, b, x: mpmath.gammainc(b, b=a*x, regularized=True),
            1, [Arg(0, 1e2, inclusive_a=False), ProbArg(),
                Arg(0, 1e3, inclusive_a=False)], rtol=1e-15)
    ...
    def test_stdtr(self):
        ...
        assert_mpmath_equal(
            sp.stdtr,
            _student_t_cdf,
            [IntArg(1, 100), Arg(1e-10, np.inf)], rtol=1e-15)
    ...
    def test_stdtridf(self):
        _assert_inverts(
            sp.stdtridf,
            _student_t_cdf,
            0, [ProbArg(), Arg()], rtol=1e-15)

    def test_stdtrit(self):
        _assert_inverts(
            sp.stdtrit,
            _student_t_cdf,
            1, [IntArg(1, 100), ProbArg()], rtol=1e-15,
    ...
    def test_chdtriv(self):
        _assert_inverts(
            ...
            0, [ProbArg(), IntArg(1, 100)], rtol=1e-15)
